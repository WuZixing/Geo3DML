...
|2.4||Version|模型的版本信息。|1|类|如“1.2.1”。模型的版本信息是模型中空间数据和非空间数据的缺省版本信息。|
|2.4.1||Timestamp|模型版本信息元素的属性：版本对应的创建时间。|1|日期|日期与时间，如“2018-04-17T14:04:33”。|
|2.5||Metadata|地质模型元数据。|0..1|类|Geo3DModelMetadata实例（见“11 元数据模块”）。|
|2.6|FeatureClasses|FeatureClasses|地质模型中包含的地质要素类的集合。|0..1|||
|2.6.1||FeatureClass|地质模型中包含的GeoFeatureClass子元素。|0..N|类|GeoFeatureClass实例（见“6.4 地质要素类”）。|
|2.7|FeatureRelationship|FeatureRelationship|地质要素间关系的集合。|0..1|||
|2.7.1||Relation|地质要素间的关系实例。|0..N|类|GeoFeatureRelation及其子类型的实例（见“7.2 地质要素之间的关系”）。|
